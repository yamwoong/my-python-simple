...
async def main():
    ...
    print(await summarize_email_en_and_ko(text_en))
    ...
    print(await summarize_email_en_and_ko(simple_en))

    # Test with too short input (should return an error)
    print("== Too Short for Summary ==")
    print(await summarize_email_en_and_ko("Hi!"))
    ...
    print(await summarize_email_en_and_ko(text_ko))
    ...
    print(await summarize_email_en_and_ko(text_ja))
